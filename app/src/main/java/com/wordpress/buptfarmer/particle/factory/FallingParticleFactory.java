...
import com.wordpress.buptfarmer.particle.particle.FallingParticle;
...
public class FallingParticleFactory extends ParticleFactory {
    ...
    public Particle[][] generateParticles(Bitmap bitmap, Rect bound) {
        ...
        Particle[][] particles = new com.wordpress.buptfarmer.particle.particle.Particle[partH_Count][partW_Count];
        Point point = null;
